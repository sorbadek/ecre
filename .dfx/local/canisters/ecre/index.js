...
import { idlFactory } from './ecre.did.js';
export { idlFactory } from './ecre.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECRE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ecre.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ecre canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ecre.did.js")._SERVICE>}
 */
export const ecre = createActor(canisterId);
