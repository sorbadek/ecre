...
exports.LEARNING_ANALYTICS_CANISTER_ID = "e2trx-sqaaa-aaaam-qdtrq-cai";
exports.NOTIFICATIONS_CANISTER_ID = "epua2-tyaaa-aaaam-qdtsa-cai";
exports.RECOMMENDATIONS_CANISTER_ID = "be2us-64aaa-aaaaa-qaabq-cai"; // Update this after deployment
exports.SESSIONS_CANISTER_ID = "br5f7-7uaaa-aaaaa-qaaca-cai";
exports.SOCIAL_CANISTER_ID = "e5sxd-7iaaa-aaaam-qdtra-cai";
exports.USER_PROFILE_CANISTER_ID = "b77ix-eeaaa-aaaaa-qaada-cai";
...
exports.customFetch = function (input, init) { return __awaiter(void 0, void 0, Promise, function () {
    var requestUrl, isLocal, headers, requestInit, response, errorText, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                requestInit = __assign(__assign({}, init), { headers: headers, mode: isLocal ? 'cors' : 'same-origin', credentials: 'same-origin' });
